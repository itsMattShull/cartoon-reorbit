...
:root {
  ...
  --topbar-adbar-promolabel-bg:         transparent;
  --topbar-adbar-promolabel-height:     var(--topbar-adbar-height);
  --topbar-adbar-promolabel-width:      20px;
  --topbar-adbar-promolabel-scale-x:    1;
  --topbar-adbar-promolabel-scale-y:    1;
  --topbar-adbar-promolabel-radius:     0px;
  --topbar-adbar-promolabel-border-thickness: 0px;
  --topbar-adbar-promolabel-border-color: transparent;
  --topbar-adbar-promolabel-pt:         0px;
  --topbar-adbar-promolabel-pb:         0px;
  --topbar-adbar-promolabel-pl:         0px;
  --topbar-adbar-promolabel-pr:         0px;

  --topbar-adbar-promo-bg:              transparent;
  --topbar-adbar-promo-height:          var(--topbar-adbar-height);
  --topbar-adbar-promo-width:           460px;
  --topbar-adbar-promo-radius:          0px;
  --topbar-adbar-promo-border-thickness: 0px;
  --topbar-adbar-promo-border-color:    transparent;
  --topbar-adbar-promo-pt:              0px;
  --topbar-adbar-promo-pb:              0px;
  --topbar-adbar-promo-pl:              0px;
  --topbar-adbar-promo-pr:              0px;
  ...
  --topbar-nav-radius:               0px;
  --topbar-nav-border-thickness:     0px;
  --topbar-nav-border-color:         transparent;;
  --topbar-nav-pt:                   0px;
  --topbar-nav-pb:                   0px;
  --topbar-nav-pl:                   0px;
  --topbar-nav-pr:                   0px;
  ...
  --topbar-nav-left-pt:              0px;
  --topbar-nav-left-pb:              0px;
  --topbar-nav-left-pl:              0px;
  --topbar-nav-left-pr:              0px;
  ...
  --topbar-nav-right-pt:             0px;
  --topbar-nav-right-pb:             0px;
  --topbar-nav-right-pl:             0px;
  ...
  <div class="site-container" :style="[{ gridTemplateRows: gridRows, gridTemplateColumns: gridColumns }, scaleStyle]">
    <div class="topbar" :style="isMobile ? { height: 'auto', overflow: 'visible', width: '100%' } : {}">
      <div class="topbar-adbar" :style="[{ visibility: showAdbar ? 'visible' : 'hidden' }, isMobile ? { width: '100%' } : {}]">
        ...
        <div class="topbar-adbar-promolabel" :style="{ marginLeft: isMobile ? '0' : 'auto' }"><ClientOnly><PromoLabel /></ClientOnly></div>
        <div class="topbar-adbar-promo" :style="isMobile ? { flex: '1', width: 'auto' } : {}"><ClientOnly><PromoSpot /></ClientOnly></div>
...
.site-container {
  ...
  padding: var(--site-container-pt) var(--site-container-pr) var(--site-container-pb) var(--site-container-pl);
  display: grid;
  grid-template-columns: var(--sidebar-width) var(--main-content-width);
  grid-template-rows: var(--topbar-height) var(--sidebar-height) var(--footer-height);
...
.topbar {
  ...
  border: var(--topbar-border-thickness) solid var(--topbar-border-color);
  padding: var(--topbar-pt) var(--topbar-pr) var(--topbar-pb) var(--topbar-pl);
  display: flex;
...
.topbar-adbar-promolabel {
  margin-left: auto;
  width: var(--topbar-adbar-promolabel-width);
  height: var(--topbar-adbar-promolabel-height);
  background: var(--topbar-adbar-promolabel-bg);
  transform: scale(var(--topbar-adbar-promolabel-scale-x), var(--topbar-adbar-promolabel-scale-y));
  border-radius: var(--topbar-adbar-promolabel-radius);
  border: var(--topbar-adbar-promolabel-border-thickness) solid var(--topbar-adbar-promolabel-border-color);
  padding: var(--topbar-adbar-promolabel-pt) var(--topbar-adbar-promolabel-pr) var(--topbar-adbar-promolabel-pb) var(--topbar-adbar-promolabel-pl);
  flex-shrink: 0;
  overflow: hidden;
}

.topbar-adbar-promo {
  width: var(--topbar-adbar-promo-width);
  height: var(--topbar-adbar-promo-height);
  background: var(--topbar-adbar-promo-bg);
  border-radius: var(--topbar-adbar-promo-radius);
  border: var(--topbar-adbar-promo-border-thickness) solid var(--topbar-adbar-promo-border-color);
  padding: var(--topbar-adbar-promo-pt) var(--topbar-adbar-promo-pr) var(--topbar-adbar-promo-pb) var(--topbar-adbar-promo-pl);
  flex-shrink: 0;
  overflow: hidden;
}
...
.topbar-nav {
  ...
  border-radius: var(--topbar-nav-radius);
  border: var(--topbar-nav-border-thickness) solid var(--topbar-nav-border-color);
  padding: var(--topbar-nav-pt) var(--topbar-nav-pr) var(--topbar-nav-pb) var(--topbar-nav-pl);
  display: flex;
  flex-direction: row;
  flex-shrink: 0;
  overflow: hidden;
...
.topbar-nav-left {
  ...
  border: var(--topbar-nav-left-border-thickness) solid var(--topbar-nav-left-border-color);
  padding: var(--topbar-nav-left-pt) var(--topbar-nav-left-pr) var(--topbar-nav-left-pb) var(--topbar-nav-left-pl);
  flex-shrink: 0;
  overflow: hidden;
}
...
.sidebar {
  ...
  border: var(--sidebar-border-thickness) solid var(--sidebar-border-color);
  padding: var(--sidebar-pt) var(--sidebar-pr) var(--sidebar-pb) var(--sidebar-pl);
  display: flex;
  flex-direction: column;
  flex-shrink: 0;
  overflow: hidden;
...
.sidebar-top {
  width: var(--sidebar-top-width);
  height: var(--sidebar-top-height);
  background: var(--sidebar-top-bg);
  border-radius: var(--sidebar-top-radius);
  border: var(--sidebar-top-border-thickness) solid var(--sidebar-top-border-color);
  padding: var(--sidebar-top-pt) var(--sidebar-top-pr) var(--sidebar-top-pb) var(--sidebar-top-pl);
  margin: var(--sidebar-top-mt) var(--sidebar-top-mr) var(--sidebar-top-mb) var(--sidebar-top-ml);
  flex-shrink: 0;
  align-self: center;
  overflow: hidden;
}
...
.sidebar-middle {
  ...
  height: var(--sidebar-middle-height);
  background: var(--sidebar-middle-bg);
...
.sidebar-bottom {
  ...
  border-radius: var(--sidebar-bottom-radius);
  border: var(--sidebar-bottom-border-thickness) solid var(--sidebar-bottom-border-color);
  padding: var(--sidebar-bottom-pt) var(--sidebar-bottom-pr) var(--sidebar-bottom-pb) var(--sidebar-bottom-pl);
  margin-top: auto;
  margin-bottom: var(--sidebar-bottom-mb);
  margin-left: var(--sidebar-bottom-ml);
  margin-right: var(--sidebar-bottom-mr);
  flex-shrink: 0;
  overflow: hidden;
  align-self: center;
}
...
.main-content {
  ...
  padding: var(--main-content-pt) var(--main-content-pr) var(--main-content-pb) var(--main-content-pl);
  overflow: hidden;
}
...
.footer {
  ...
  padding: var(--footer-pt) var(--footer-pr) var(--footer-pb) var(--footer-pl);
  overflow: hidden;
}
</style>
