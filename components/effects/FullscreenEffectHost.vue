...
<script setup>
// Global host for the reusable full-screen cMoon effects (Glitch/Slime). Mounted once, outside
...
const statusText = computed(() => {
  ...
  return type.value === 'SLIME' ? 'Slime effect playing' : 'Glitch effect playing'
})
