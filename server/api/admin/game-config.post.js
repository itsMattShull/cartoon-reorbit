...
function validatePayload(payload) {
  ...
  if (payload.gameName === 'Winball') {
    ...
    const physicsFields = [
      ...
      'winballTriangle3Radius','winballTriangle3Depth','winballTriangle3X','winballTriangle3Z',
...
export default defineEventHandler(async (event) => {
  ...
  const {
    ...
    winballTriangle3Radius = null,
    winballTriangle3Depth = null,
    winballTriangle3X = null,
    winballTriangle3Z = null,
    ...
    const result = await db.$transaction(async tx => {
      ...
      if (gameName === 'Winball') {
        ...
        const winballPhysics = {
          ...
          winballTriangle3Radius: winballTriangle3Radius ?? 4,
          winballTriangle3Depth:  winballTriangle3Depth  ?? 6,
          winballTriangle3X:      winballTriangle3X      ?? 13,
          winballTriangle3Z:      winballTriangle3Z      ?? -2,
          winballPeg1Radius:  winballPeg1Radius  ?? 0.5, winballPeg1Height:  winballPeg1Height  ?? 4, winballPeg1X:  winballPeg1X  ?? -11, winballPeg1Z:  winballPeg1Z  ?? -17,
          winballPeg2Radius:  winballPeg2Radius  ?? 0.5, winballPeg2Height:  winballPeg2Height  ?? 4, winballPeg2X:  winballPeg2X  ?? -3,  winballPeg2Z:  winballPeg2Z  ?? -17,
          winballPeg3Radius:  winballPeg3Radius  ?? 0.5, winballPeg3Height:  winballPeg3Height  ?? 4, winballPeg3X:  winballPeg3X  ?? 5,   winballPeg3Z:  winballPeg3Z  ?? -17,
          winballPeg4Radius:  winballPeg4Radius  ?? 0.5, winballPeg4Height:  winballPeg4Height  ?? 4, winballPeg4X:  winballPeg4X  ?? 12,  winballPeg4Z:  winballPeg4Z  ?? -17,
          winballPeg5Radius:  winballPeg5Radius  ?? 0.5, winballPeg5Height:  winballPeg5Height  ?? 4, winballPeg5X:  winballPeg5X  ?? -12, winballPeg5Z:  winballPeg5Z  ?? -6,
          winballPeg6Radius:  winballPeg6Radius  ?? 0.5, winballPeg6Height:  winballPeg6Height  ?? 4, winballPeg6X:  winballPeg6X  ?? -5,  winballPeg6Z:  winballPeg6Z  ?? -6,
          winballPeg7Radius:  winballPeg7Radius  ?? 0.5, winballPeg7Height:  winballPeg7Height  ?? 4, winballPeg7X:  winballPeg7X  ?? 2,   winballPeg7Z:  winballPeg7Z  ?? -6,
          winballPeg8Radius:  winballPeg8Radius  ?? 0.5, winballPeg8Height:  winballPeg8Height  ?? 4, winballPeg8X:  winballPeg8X  ?? 10,  winballPeg8Z:  winballPeg8Z  ?? -6,
          winballPeg9Radius:  winballPeg9Radius  ?? 0.5, winballPeg9Height:  winballPeg9Height  ?? 4, winballPeg9X:  winballPeg9X  ?? -12, winballPeg9Z:  winballPeg9Z  ?? 4,
          winballPeg10Radius: winballPeg10Radius ?? 0.5, winballPeg10Height: winballPeg10Height ?? 4, winballPeg10X: winballPeg10X ?? -5,  winballPeg10Z: winballPeg10Z ?? 5,
          winballPeg11Radius: winballPeg11Radius ?? 0.5, winballPeg11Height: winballPeg11Height ?? 4, winballPeg11X: winballPeg11X ?? 3,   winballPeg11Z: winballPeg11Z ?? 4,
          winballPeg12Radius: winballPeg12Radius ?? 0.5, winballPeg12Height: winballPeg12Height ?? 4, winballPeg12X: winballPeg12X ?? 11,  winballPeg12Z: winballPeg12Z ?? 4
        }
        createData = {
          ...createData,
          leftCupPoints,
      ...
      try {
        ...
        if (gameName === 'Winball') {
          const changes = [
            ...
            ['winballTriangle3Radius', before?.winballTriangle3Radius, winballTriangle3Radius],
            ['winballTriangle3Depth', before?.winballTriangle3Depth, winballTriangle3Depth],
            ['winballTriangle3X', before?.winballTriangle3X, winballTriangle3X],
            ['winballTriangle3Z', before?.winballTriangle3Z, winballTriangle3Z],
