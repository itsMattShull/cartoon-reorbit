...
const CACHE_KEY  = 'asteroid:leaderboard:v1'
const CACHE_TTL  = 1800  // 30 minutes
const EXCLUDE_ID = '4f0e8b3b-7d0b-466b-99e7-8996c91d7eb3'

// Interpolated into the SQL below. Both this map and EXCLUDE_ID are module constants that never
// touch request input; the only request-derived value (userId) is passed as a bound parameter.
