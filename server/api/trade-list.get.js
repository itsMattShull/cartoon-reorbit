  ...
  await prisma.userTradeListItem.deleteMany({
    where: {
      ...
      OR: [
        ...
        // Favoriting drops the trade-list row, and the trade-list POST refuses a
        // favorited copy — but the two touch different rows with no shared lock,
        ...
        { userCtoon: { favoritedByUserId: userId } }
      ]
    }
  })
